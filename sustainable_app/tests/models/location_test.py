...
class LocationModelTests(TestCase):
    ...
    def test_path_and_rename(self):
        ...
        location = Location(
            name="test-name", category="test-category", clue="test-clue")
        location.save()
        ...
        location.image = SimpleUploadedFile(
            'small.gif', small_gif, content_type='image/gif')
        location.save()

        self.assertEquals(location.image.url,
                          "/location_images/img_" + str(location.id) + ".png")
