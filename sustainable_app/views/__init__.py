...
from .game_keeper import (
    game_keeper, game_keeper_locations, game_keeper_surveys,
    game_keeper_questions, remove_keeper, locations_remove,
    questions_remove, surveys_remove, open_file
)


__all__ = [
    'login', 'register', 'privacy_policy', 'logout',
    ...
    'game_keeper', 'game_keeper_locations',
    'game_keeper_surveys', 'game_keeper_questions',
    'remove_keeper', 'locations_remove', 'questions_remove',
    'surveys_remove', 'open_file',
